...
_lr_productions = [
  ...
  ('stuff -> <empty>','stuff',0,'p_stuff','/home/felipe/graphics_final/mdl.py',131),
  ('stuff -> statement stuff','stuff',2,'p_stuff','/home/felipe/graphics_final/mdl.py',132),
  ('statement -> COMMENT','statement',1,'p_statement_comment','/home/felipe/graphics_final/mdl.py',136),
  ('statement -> FRAMES INT','statement',2,'p_statement_frames','/home/felipe/graphics_final/mdl.py',140),
  ('statement -> BASENAME TEXT','statement',2,'p_statement_basename','/home/felipe/graphics_final/mdl.py',144),
  ('statement -> VARY SYMBOL INT INT NUMBER NUMBER','statement',6,'p_statement_vary','/home/felipe/graphics_final/mdl.py',148),
  ('statement -> POP','statement',1,'p_statement_stack','/home/felipe/graphics_final/mdl.py',153),
  ('statement -> PUSH','statement',1,'p_statement_stack','/home/felipe/graphics_final/mdl.py',154),
  ('statement -> SCREEN INT INT','statement',3,'p_statement_screen','/home/felipe/graphics_final/mdl.py',158),
  ('statement -> SCREEN','statement',1,'p_statement_screen','/home/felipe/graphics_final/mdl.py',159),
  ('statement -> SAVE','statement',1,'p_statement_save','/home/felipe/graphics_final/mdl.py',166),
  ('statement -> SAVE TEXT','statement',2,'p_statement_save','/home/felipe/graphics_final/mdl.py',167),
  ('statement -> DISPLAY TEXT','statement',2,'p_statement_show','/home/felipe/graphics_final/mdl.py',174),
  ('statement -> DISPLAY','statement',1,'p_statement_show','/home/felipe/graphics_final/mdl.py',175),
  ('statement -> SET SYMBOL NUMBER','statement',3,'p_statement_knobs','/home/felipe/graphics_final/mdl.py',179),
  ('statement -> SET_KNOBS NUMBER','statement',2,'p_statement_knobs','/home/felipe/graphics_final/mdl.py',180),
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER INT INT','statement',7,'p_statement_sphere','/home/felipe/graphics_final/mdl.py',186),
  ('statement -> SPHERE NUMBER NUMBER NUMBER NUMBER','statement',5,'p_statement_sphere','/home/felipe/graphics_final/mdl.py',187),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER INT INT','statement',8,'p_statement_torus','/home/felipe/graphics_final/mdl.py',194),
  ('statement -> TORUS NUMBER NUMBER NUMBER NUMBER NUMBER','statement',6,'p_statement_torus','/home/felipe/graphics_final/mdl.py',195),
  ('statement -> BOX NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_box','/home/felipe/graphics_final/mdl.py',202),
  ('statement -> LINE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',7,'p_statement_line','/home/felipe/graphics_final/mdl.py',206),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',8,'p_statement_circle','/home/felipe/graphics_final/mdl.py',210),
  ('statement -> CIRCLE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',9,'p_statement_circle','/home/felipe/graphics_final/mdl.py',211),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','/home/felipe/graphics_final/mdl.py',221),
  ('statement -> BEZIER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','/home/felipe/graphics_final/mdl.py',222),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER INT','statement',14,'p_statement_curve','/home/felipe/graphics_final/mdl.py',223),
  ('statement -> HERMITE NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER NUMBER','statement',13,'p_statement_curve','/home/felipe/graphics_final/mdl.py',224),
  ('statement -> MOVE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_move','/home/felipe/graphics_final/mdl.py',231),
  ('statement -> MOVE NUMBER NUMBER NUMBER','statement',4,'p_statement_move','/home/felipe/graphics_final/mdl.py',232),
  ('statement -> SCALE NUMBER NUMBER NUMBER SYMBOL','statement',5,'p_statement_scale','/home/felipe/graphics_final/mdl.py',240),
  ('statement -> SCALE NUMBER NUMBER NUMBER','statement',4,'p_statement_scale','/home/felipe/graphics_final/mdl.py',241),
  ('statement -> ROTATE XYZ NUMBER SYMBOL','statement',4,'p_statement_rotate','/home/felipe/graphics_final/mdl.py',249),
  ('statement -> ROTATE XYZ NUMBER','statement',3,'p_statement_rotate','/home/felipe/graphics_final/mdl.py',250),
  ('SYMBOL -> XYZ','SYMBOL',1,'p_SYMBOL','/home/felipe/graphics_final/mdl.py',258),
  ('SYMBOL -> ID','SYMBOL',1,'p_SYMBOL','/home/felipe/graphics_final/mdl.py',259),
  ('TEXT -> SYMBOL','TEXT',1,'p_TEXT','/home/felipe/graphics_final/mdl.py',263),
  ('TEXT -> STRING','TEXT',1,'p_TEXT','/home/felipe/graphics_final/mdl.py',264),
  ('NUMBER -> DOUBLE','NUMBER',1,'p_NUMBER','/home/felipe/graphics_final/mdl.py',268),
  ('NUMBER -> INT','NUMBER',1,'p_NUMBER','/home/felipe/graphics_final/mdl.py',269),
]
